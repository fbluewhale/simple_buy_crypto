...
class Order(BaseModel):
    ...
    purchase_price = models.DecimalField("Crypto purchase price", default=0)
    sale_price = models.DecimalField("Crypto sales price", default=0)
    total_price = models.DecimalField("order total price", default=0)

    external_checkout = models.BooleanField(default=False)
    amount = models.DecimalField(decimal_places=1, max_digits=0)
